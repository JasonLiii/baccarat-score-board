 ...
 */
function generateSmallRoadItemList(bigRoadItemGraph: RoadArray<BigRoadItem>): ReadonlyArray<DownRoadItem> {
 ...
 */
function generateSmallRoadGraph(bigRoadGraph: RoadArray<BigRoadItem>, rowCount: number, columnCount: number): RoadArray<DownRoadItem> {
  return wrapRow(
    wrapColumn(
